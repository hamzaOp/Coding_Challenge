...
class Gallery extends Component {
  ...
  changeToPhotosContext(e){
    ...
    let uri = {
      uri: 'https://graph.facebook.com/v2.10/' + this.state.albums.dataSet[0].id + '?fields=photos{name,source,created_time}&' + 'access_token=' + this.props.facebook.token,
      headers: {
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              {!this.state.no_albums ? (this.state[context].loading ? <h2>Loading...</h2> : <div>{galleryItems}</div>) : <h2>This user has no albums</h2>}

            </div>

            <Widget {...this.props} previous={this.state[context].previous} next={this.state[context].next} previousClick={this.previousHandler.bind(this)} nextClick={this.nextHandler.bind(this)} changeToAlbums={this.changeToAlbumsContext.bind(this)} context={context} changeToPhotos={this.changeToPhotosContext.bind(this)} no_albums={this.state.no_albums} />
